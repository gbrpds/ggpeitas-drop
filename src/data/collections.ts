...
export const leagueCollections: LeagueCollection[] = [
  ...
  { title: "Serie A TIM", href: "/busca?team=Juventus,Milan,Inter de Milão", colors: ["#0b6e30", "#c8102e"], image: "/ligas/serie-a.jpg" },
  { title: "Bundesliga", href: "/busca?team=Bayern de Munique", colors: ["#111111", "#d20515"], image: "/ligas/bundesliga.jpg" },
  { title: "Ligue One", href: "/busca?team=PSG", colors: ["#0a1a4f", "#c8102e"], image: "/ligas/ligue-one.jpg" },
  { title: "Liga Argentina", href: "/busca?team=Boca Juniors,River Plate", colors: ["#6caee0", "#1b3a6b"], image: "/ligas/lpf.jpg" },
];
