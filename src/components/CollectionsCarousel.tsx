...
export function CollectionsCarousel() {
  ...
  return (
    <section className="col-sec wrap reveal">
      <div className="car-head">
        <h2>Coleções</h2>
        <div className="col-arrows">
          <button aria-label="Anterior" onClick={() => scroll(-1)}><ChevronLeft size={20} strokeWidth={2.4} /></button>
          <button aria-label="Próximo" onClick={() => scroll(1)}><ChevronRight size={20} strokeWidth={2.4} /></button>
        </div>
      </div>

      <div className="col-track" ref={trackRef}>
        {teams.map((t) => {
