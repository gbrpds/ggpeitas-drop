...
export const EURO_TEAMS: EuroTeam[] = [
  ...
  // Bundesliga (Bayern/Dortmund/Hamburgo acima)
  { name: "Eintracht Frankfurt", keys: ["eintrachtfrankfurt", "frankfurt"], league: "bundesliga" },
  { name: "RB Leipzig", keys: ["rbleipzig", "leipzig"], league: "bundesliga" },
  { name: "Schalke 04", keys: ["schalke04", "schalke"], league: "bundesliga" },
  { name: "Köln", keys: ["fckoln", "koln", "cologne"], league: "bundesliga" },
  { name: "Werder Bremen", keys: ["werderbremen", "bremen"], league: "bundesliga" },
  { name: "Bayer Leverkusen", keys: ["bayerleverkusen", "leverkusen"], league: "bundesliga" },
  { name: "Borussia Mönchengladbach", keys: ["borussiamonchengladbach", "monchengladbach", "gladbach"], league: "bundesliga" },
  { name: "St. Pauli", keys: ["stpauli"], league: "bundesliga" },
  { name: "Wolfsburg", keys: ["vflwolfsburg", "wolfsburg"], league: "bundesliga" },
  { name: "Nürnberg", keys: ["fcnurnberg", "nurnberg", "nuremberg"], league: "bundesliga" },
  { name: "Augsburg", keys: ["fcaugsburg", "augsburg"], league: "bundesliga" },
  { name: "MSV Duisburg", keys: ["msvduisburg", "duisburg"], league: "bundesliga" },
  { name: "Freiburg", keys: ["scfreiburg", "freiburg"], league: "bundesliga" },
  { name: "Rot-Weiss Essen", keys: ["rotweissessen"], league: "bundesliga" },
  { name: "VfL Bochum", keys: ["vflbochum", "bochum"], league: "bundesliga" },
  { name: "Holstein Kiel", keys: ["holsteinkiel"], league: "bundesliga" },
  { name: "Hansa Rostock", keys: ["hansarostock", "rostock"], league: "bundesliga" },
  { name: "Fortuna Düsseldorf", keys: ["fortunadusseldorf", "dusseldorf"], league: "bundesliga" },
  { name: "Kaiserslautern", keys: ["kaiserslautern"], league: "bundesliga" },
  { name: "Hannover 96", keys: ["hannover96", "hannover"], league: "bundesliga" },
  { name: "Karlsruher", keys: ["karlsruhersc", "karlsruher", "karlsruhe"], league: "bundesliga" },
  { name: "Union Berlin", keys: ["unionberlin"], league: "bundesliga" },
  { name: "Stuttgart", keys: ["vfbstuttgart", "stuttgart"], league: "bundesliga" },
];
